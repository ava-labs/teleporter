...
if [ ! -e $dir_prefix/NETWORK_RUNNING ]; then
    ...
    registry_deploy_result_a=$(forge create --private-key $user_private_key \
        --rpc-url $subnet_a_url src/Teleporter/upgrades/TeleporterRegistry.sol:TeleporterRegistry --constructor-args "[(1,$teleporter_contract_address,$teleporter_contract_address)]")
    ...
    registry_deploy_result_b=$(forge create --private-key $user_private_key \
        --rpc-url $subnet_b_url src/Teleporter/upgrades/TeleporterRegistry.sol:TeleporterRegistry --constructor-args "[(1,$teleporter_contract_address,$teleporter_contract_address)]")
    ...
    registry_deploy_result_c=$(forge create --private-key $user_private_key \
        --rpc-url $subnet_c_url src/Teleporter/upgrades/TeleporterRegistry.sol:TeleporterRegistry --constructor-args "[(1,$teleporter_contract_address,$teleporter_contract_address)]")

...
DEFAULT_CONTRACT_LIST="TeleporterTokenSource TeleporterTokenDestination ERC20Source ERC20Destination NativeTokenSource NativeTokenDestination WrappedNativeToken MockERC20SendAndCallReceiver MockNativeSendAndCallReceiver ExampleERC20"

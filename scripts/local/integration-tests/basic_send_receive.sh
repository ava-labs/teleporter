...
send_cross_subnet_message_fee_amount=400000000000000000
...
echo "params: $erc20_contract_address_a $teleporter_contract_address $user_private_key $subnet_a_url"
cast send $erc20_contract_address_a "approve(address,uint256)(bool)" $teleporter_contract_address $approve_amount --private-key $user_private_key --rpc-url $subnet_a_url

...
import {TeleporterMessengerTest, TeleporterMessage, TeleporterMessageReceipt, TeleporterFeeInfo, WarpMessenger, IERC20} from "./TeleporterMessengerTest.t.sol";
...
contract SendSpecifiedReceiptsTest is TeleporterMessengerTest {
    ...
    function testSuccess() public {
        ...
        outboundMessageID = _sendSpecifiedReceiptsWithNoFee(
            DEFAULT_DESTINATION_CHAIN_ID,
            receiptIDs
        );
    ...
    function testDuplicateAllowed() public {
        ...
        uint256 outboundMessageID = _sendSpecifiedReceiptsWithNoFee(
            DEFAULT_DESTINATION_CHAIN_ID,
            messageIDs
        );
        assertEq(outboundMessageID, 1);
    ...
    function testMissingMessage() public {
        ...
        _sendSpecifiedReceiptsWithNoFee(
            DEFAULT_DESTINATION_CHAIN_ID,
            missingIDs
        );
    }

 ...
 * @param multiplyOnSpoke Whether the token multiplier should be applied when transferring tokens to the spoke (multiplyOnSpoke=true),
 * or when transferring tokens back to the hub (multiplyOnSpoke=false).
 */

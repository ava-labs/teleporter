...
library TokenScalingUtils {
     ...
     * @param multiplyOnSpoke Whether the amount of source tokens will be multiplied on the destination, or divided.
    ...
    function applyTokenScale(
        ...
        return _scaleTokens(tokenMultiplier, multiplyOnSpoke, sourceTokenAmount, true);
    }
    ...
    function removeTokenScale(
        ...
        return _scaleTokens(tokenMultiplier, multiplyOnSpoke, destinationTokenAmount, false);
    }

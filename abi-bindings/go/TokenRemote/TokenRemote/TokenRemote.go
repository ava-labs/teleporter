...
func (_TokenRemote *TokenRemoteCaller) REGISTERSPOKEREQUIREDGAS(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _TokenRemote.contract.Call(opts, &out, "REGISTER_SPOKE_REQUIRED_GAS")
...
//
// Solidity: function REGISTER_SPOKE_REQUIRED_GAS() view returns(uint256)
func (_TokenRemote *TokenRemoteSession) REGISTERSPOKEREQUIREDGAS() (*big.Int, error) {
	return _TokenRemote.Contract.REGISTERSPOKEREQUIREDGAS(&_TokenRemote.CallOpts)
}

// REGISTERSPOKEREQUIREDGAS is a free data retrieval call binding the contract method 0xc03f4013.
//
// Solidity: function REGISTER_SPOKE_REQUIRED_GAS() view returns(uint256)
func (_TokenRemote *TokenRemoteCallerSession) REGISTERSPOKEREQUIREDGAS() (*big.Int, error) {
	return _TokenRemote.Contract.REGISTERSPOKEREQUIREDGAS(&_TokenRemote.CallOpts)
}

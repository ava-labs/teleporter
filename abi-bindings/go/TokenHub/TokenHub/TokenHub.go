...
func (_TokenHub *TokenHubCaller) MAXTOKENMULTIPLIER(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _TokenHub.contract.Call(opts, &out, "MAX_TOKEN_MULTIPLIER")
...
//
// Solidity: function MAX_TOKEN_MULTIPLIER() view returns(uint256)
func (_TokenHub *TokenHubSession) MAXTOKENMULTIPLIER() (*big.Int, error) {
	return _TokenHub.Contract.MAXTOKENMULTIPLIER(&_TokenHub.CallOpts)
}

// MAXTOKENMULTIPLIER is a free data retrieval call binding the contract method 0x008ad777.
//
// Solidity: function MAX_TOKEN_MULTIPLIER() view returns(uint256)
func (_TokenHub *TokenHubCallerSession) MAXTOKENMULTIPLIER() (*big.Int, error) {
	return _TokenHub.Contract.MAXTOKENMULTIPLIER(&_TokenHub.CallOpts)
}
...
// FilterSpokeRegistered is a free log retrieval operation binding the contract event 0x2ad81ffe1d79c673eb0e2cdcd25e20fcbd969a60673df31c08c2ad542527e476.
//
// Solidity: event SpokeRegistered(bytes32 indexed spokeBlockchainID, address indexed spokeBridgeAddress, uint256 initialCollateralNeeded, uint256 tokenMultiplier, bool multiplyOnSpoke)
...
// WatchSpokeRegistered is a free log subscription operation binding the contract event 0x2ad81ffe1d79c673eb0e2cdcd25e20fcbd969a60673df31c08c2ad542527e476.
//
// Solidity: event SpokeRegistered(bytes32 indexed spokeBlockchainID, address indexed spokeBridgeAddress, uint256 initialCollateralNeeded, uint256 tokenMultiplier, bool multiplyOnSpoke)
...
// ParseSpokeRegistered is a log parse operation binding the contract event 0x2ad81ffe1d79c673eb0e2cdcd25e20fcbd969a60673df31c08c2ad542527e476.
//
// Solidity: event SpokeRegistered(bytes32 indexed spokeBlockchainID, address indexed spokeBridgeAddress, uint256 initialCollateralNeeded, uint256 tokenMultiplier, bool multiplyOnSpoke)

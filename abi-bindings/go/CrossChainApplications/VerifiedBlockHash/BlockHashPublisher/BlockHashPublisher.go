...
func (_BlockHashPublisher *BlockHashPublisherCaller) MinTeleporterVersion(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _BlockHashPublisher.contract.Call(opts, &out, "minTeleporterVersion")
...
//
// Solidity: function minTeleporterVersion() view returns(uint256)
func (_BlockHashPublisher *BlockHashPublisherSession) MinTeleporterVersion() (*big.Int, error) {
	return _BlockHashPublisher.Contract.MinTeleporterVersion(&_BlockHashPublisher.CallOpts)
}

// MinTeleporterVersion is a free data retrieval call binding the contract method 0xe49cc553.
//
// Solidity: function minTeleporterVersion() view returns(uint256)
func (_BlockHashPublisher *BlockHashPublisherCallerSession) MinTeleporterVersion() (*big.Int, error) {
	return _BlockHashPublisher.Contract.MinTeleporterVersion(&_BlockHashPublisher.CallOpts)
}
...
// BlockHashPublisherMinTeleporterVersionUpdatedIterator is returned from FilterMinTeleporterVersionUpdated and is used to iterate over the raw logs and unpacked data for MinTeleporterVersionUpdated events raised by the BlockHashPublisher contract.
type BlockHashPublisherMinTeleporterVersionUpdatedIterator struct {
	Event *BlockHashPublisherMinTeleporterVersionUpdated // Event containing the contract specifics and raw log
...
func (it *BlockHashPublisherMinTeleporterVersionUpdatedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(BlockHashPublisherMinTeleporterVersionUpdated)
...
func (it *BlockHashPublisherMinTeleporterVersionUpdatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *BlockHashPublisherMinTeleporterVersionUpdatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// BlockHashPublisherMinTeleporterVersionUpdated represents a MinTeleporterVersionUpdated event raised by the BlockHashPublisher contract.
type BlockHashPublisherMinTeleporterVersionUpdated struct {
...
func (_BlockHashPublisher *BlockHashPublisherFilterer) FilterMinTeleporterVersionUpdated(opts *bind.FilterOpts, oldMinTeleporterVersion []*big.Int, newMinTeleporterVersion []*big.Int) (*BlockHashPublisherMinTeleporterVersionUpdatedIterator, error) {
	...
	logs, sub, err := _BlockHashPublisher.contract.FilterLogs(opts, "MinTeleporterVersionUpdated", oldMinTeleporterVersionRule, newMinTeleporterVersionRule)
	if err != nil {
		return nil, err
	}
	return &BlockHashPublisherMinTeleporterVersionUpdatedIterator{contract: _BlockHashPublisher.contract, event: "MinTeleporterVersionUpdated", logs: logs, sub: sub}, nil
}

// WatchMinTeleporterVersionUpdated is a free log subscription operation binding the contract event 0xa9a7ef57e41f05b4c15480842f5f0c27edfcbb553fed281f7c4068452cc1c02d.
//
// Solidity: event MinTeleporterVersionUpdated(uint256 indexed oldMinTeleporterVersion, uint256 indexed newMinTeleporterVersion)
func (_BlockHashPublisher *BlockHashPublisherFilterer) WatchMinTeleporterVersionUpdated(opts *bind.WatchOpts, sink chan<- *BlockHashPublisherMinTeleporterVersionUpdated, oldMinTeleporterVersion []*big.Int, newMinTeleporterVersion []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _BlockHashPublisher.contract.WatchLogs(opts, "MinTeleporterVersionUpdated", oldMinTeleporterVersionRule, newMinTeleporterVersionRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(BlockHashPublisherMinTeleporterVersionUpdated)
				if err := _BlockHashPublisher.contract.UnpackLog(event, "MinTeleporterVersionUpdated", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event MinTeleporterVersionUpdated(uint256 indexed oldMinTeleporterVersion, uint256 indexed newMinTeleporterVersion)
func (_BlockHashPublisher *BlockHashPublisherFilterer) ParseMinTeleporterVersionUpdated(log types.Log) (*BlockHashPublisherMinTeleporterVersionUpdated, error) {
	event := new(BlockHashPublisherMinTeleporterVersionUpdated)
	if err := _BlockHashPublisher.contract.UnpackLog(event, "MinTeleporterVersionUpdated", log); err != nil {
		return nil, err
	}

...
var MockNativeSendAndCallReceiverMetaData = &bind.MetaData{
	...
	Bin: "",
}
...
//
// Solidity: function receiveTokens(bytes32 sourceBlockchainID, address originTokenTransfererAddress, address originSenderAddress, bytes payload) payable returns()
func (_MockNativeSendAndCallReceiver *MockNativeSendAndCallReceiverTransactor) ReceiveTokens(opts *bind.TransactOpts, sourceBlockchainID [32]byte, originTokenTransfererAddress common.Address, originSenderAddress common.Address, payload []byte) (*types.Transaction, error) {
	return _MockNativeSendAndCallReceiver.contract.Transact(opts, "receiveTokens", sourceBlockchainID, originTokenTransfererAddress, originSenderAddress, payload)
}

// ReceiveTokens is a paid mutator transaction binding the contract method 0x2c3625fe.
//
// Solidity: function receiveTokens(bytes32 sourceBlockchainID, address originTokenTransfererAddress, address originSenderAddress, bytes payload) payable returns()
func (_MockNativeSendAndCallReceiver *MockNativeSendAndCallReceiverSession) ReceiveTokens(sourceBlockchainID [32]byte, originTokenTransfererAddress common.Address, originSenderAddress common.Address, payload []byte) (*types.Transaction, error) {
	return _MockNativeSendAndCallReceiver.Contract.ReceiveTokens(&_MockNativeSendAndCallReceiver.TransactOpts, sourceBlockchainID, originTokenTransfererAddress, originSenderAddress, payload)
}

// ReceiveTokens is a paid mutator transaction binding the contract method 0x2c3625fe.
//
// Solidity: function receiveTokens(bytes32 sourceBlockchainID, address originTokenTransfererAddress, address originSenderAddress, bytes payload) payable returns()
func (_MockNativeSendAndCallReceiver *MockNativeSendAndCallReceiverTransactorSession) ReceiveTokens(sourceBlockchainID [32]byte, originTokenTransfererAddress common.Address, originSenderAddress common.Address, payload []byte) (*types.Transaction, error) {
	return _MockNativeSendAndCallReceiver.Contract.ReceiveTokens(&_MockNativeSendAndCallReceiver.TransactOpts, sourceBlockchainID, originTokenTransfererAddress, originSenderAddress, payload)
}
...
//
// Solidity: event TokensReceived(bytes32 indexed sourceBlockchainID, address indexed originTokenTransfererAddress, address indexed originSenderAddress, uint256 amount, bytes payload)
func (_MockNativeSendAndCallReceiver *MockNativeSendAndCallReceiverFilterer) FilterTokensReceived(opts *bind.FilterOpts, sourceBlockchainID [][32]byte, originTokenTransfererAddress []common.Address, originSenderAddress []common.Address) (*MockNativeSendAndCallReceiverTokensReceivedIterator, error) {
	...
	logs, sub, err := _MockNativeSendAndCallReceiver.contract.FilterLogs(opts, "TokensReceived", sourceBlockchainIDRule, originTokenTransfererAddressRule, originSenderAddressRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event TokensReceived(bytes32 indexed sourceBlockchainID, address indexed originTokenTransfererAddress, address indexed originSenderAddress, uint256 amount, bytes payload)
func (_MockNativeSendAndCallReceiver *MockNativeSendAndCallReceiverFilterer) WatchTokensReceived(opts *bind.WatchOpts, sink chan<- *MockNativeSendAndCallReceiverTokensReceived, sourceBlockchainID [][32]byte, originTokenTransfererAddress []common.Address, originSenderAddress []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _MockNativeSendAndCallReceiver.contract.WatchLogs(opts, "TokensReceived", sourceBlockchainIDRule, originTokenTransfererAddressRule, originSenderAddressRule)
	if err != nil {
		return nil, err
	}

...
func (_TeleporterTokenDestination *TeleporterTokenDestinationCaller) SourceTokenDecimals(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _TeleporterTokenDestination.contract.Call(opts, &out, "sourceTokenDecimals")
...
//
// Solidity: function sourceTokenDecimals() view returns(uint8)
func (_TeleporterTokenDestination *TeleporterTokenDestinationSession) SourceTokenDecimals() (uint8, error) {
	return _TeleporterTokenDestination.Contract.SourceTokenDecimals(&_TeleporterTokenDestination.CallOpts)
}

// SourceTokenDecimals is a free data retrieval call binding the contract method 0xb789e1d8.
//
// Solidity: function sourceTokenDecimals() view returns(uint8)
func (_TeleporterTokenDestination *TeleporterTokenDestinationCallerSession) SourceTokenDecimals() (uint8, error) {
	return _TeleporterTokenDestination.Contract.SourceTokenDecimals(&_TeleporterTokenDestination.CallOpts)
}
...
func (_TeleporterTokenDestination *TeleporterTokenDestinationCaller) TokenDecimals(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _TeleporterTokenDestination.contract.Call(opts, &out, "tokenDecimals")
...
//
// Solidity: function tokenDecimals() view returns(uint8)
func (_TeleporterTokenDestination *TeleporterTokenDestinationSession) TokenDecimals() (uint8, error) {
	return _TeleporterTokenDestination.Contract.TokenDecimals(&_TeleporterTokenDestination.CallOpts)
}

// TokenDecimals is a free data retrieval call binding the contract method 0x3b97e856.
//
// Solidity: function tokenDecimals() view returns(uint8)
func (_TeleporterTokenDestination *TeleporterTokenDestinationCallerSession) TokenDecimals() (uint8, error) {
	return _TeleporterTokenDestination.Contract.TokenDecimals(&_TeleporterTokenDestination.CallOpts)
}

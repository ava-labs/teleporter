...
func (_TeleporterTokenDestination *TeleporterTokenDestinationCaller) multiplyOnSpoke(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _TeleporterTokenDestination.contract.Call(opts, &out, "multiplyOnSpoke")
...
//
// Solidity: function multiplyOnSpoke() view returns(bool)
func (_TeleporterTokenDestination *TeleporterTokenDestinationSession) multiplyOnSpoke() (bool, error) {
	return _TeleporterTokenDestination.Contract.multiplyOnSpoke(&_TeleporterTokenDestination.CallOpts)
}

// multiplyOnSpoke is a free data retrieval call binding the contract method 0x2001eff6.
//
// Solidity: function multiplyOnSpoke() view returns(bool)
func (_TeleporterTokenDestination *TeleporterTokenDestinationCallerSession) multiplyOnSpoke() (bool, error) {
	return _TeleporterTokenDestination.Contract.multiplyOnSpoke(&_TeleporterTokenDestination.CallOpts)
}

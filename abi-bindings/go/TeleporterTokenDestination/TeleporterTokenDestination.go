...
func (_TeleporterTokenDestination *TeleporterTokenDestinationCaller) MultiplyOnReceive(opts *bind.CallOpts) (bool, error) {
	var out []interface{}
	err := _TeleporterTokenDestination.contract.Call(opts, &out, "multiplyOnReceive")
...
//
// Solidity: function multiplyOnReceive() view returns(bool)
func (_TeleporterTokenDestination *TeleporterTokenDestinationSession) MultiplyOnReceive() (bool, error) {
	return _TeleporterTokenDestination.Contract.MultiplyOnReceive(&_TeleporterTokenDestination.CallOpts)
}

// MultiplyOnReceive is a free data retrieval call binding the contract method 0x1ce22075.
//
// Solidity: function multiplyOnReceive() view returns(bool)
func (_TeleporterTokenDestination *TeleporterTokenDestinationCallerSession) MultiplyOnReceive() (bool, error) {
	return _TeleporterTokenDestination.Contract.MultiplyOnReceive(&_TeleporterTokenDestination.CallOpts)
}

...
func (_TeleporterTokenDestination *TeleporterTokenDestinationFilterer) FilterTokensAndCallSent(opts *bind.FilterOpts, teleporterMessageID [][32]byte, bridgeAddress []common.Address, sender []common.Address) (*TeleporterTokenDestinationTokensAndCallSentIterator, error) {
	...
	logs, sub, err := _TeleporterTokenDestination.contract.FilterLogs(opts, "TokensAndCallSent", teleporterMessageIDRule, bridgeAddressRule, senderRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event TokensAndCallSent(bytes32 indexed teleporterMessageID, address indexed bridgeAddress, address indexed sender, (bytes32,address,address,bytes,uint256,uint256,address,address,address,uint256,uint256) input, uint256 amount)
func (_TeleporterTokenDestination *TeleporterTokenDestinationFilterer) WatchTokensAndCallSent(opts *bind.WatchOpts, sink chan<- *TeleporterTokenDestinationTokensAndCallSent, teleporterMessageID [][32]byte, bridgeAddress []common.Address, sender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TeleporterTokenDestination.contract.WatchLogs(opts, "TokensAndCallSent", teleporterMessageIDRule, bridgeAddressRule, senderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {

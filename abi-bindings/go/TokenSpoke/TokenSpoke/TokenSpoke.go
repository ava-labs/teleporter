...
func (_TokenSpoke *TokenSpokeCaller) MULTIHOPCALLREQUIREDGAS(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _TokenSpoke.contract.Call(opts, &out, "MULTI_HOP_CALL_REQUIRED_GAS")
...
//
// Solidity: function MULTI_HOP_CALL_REQUIRED_GAS() view returns(uint256)
func (_TokenSpoke *TokenSpokeSession) MULTIHOPCALLREQUIREDGAS() (*big.Int, error) {
	return _TokenSpoke.Contract.MULTIHOPCALLREQUIREDGAS(&_TokenSpoke.CallOpts)
}

// MULTIHOPCALLREQUIREDGAS is a free data retrieval call binding the contract method 0x71717c18.
//
// Solidity: function MULTI_HOP_CALL_REQUIRED_GAS() view returns(uint256)
func (_TokenSpoke *TokenSpokeCallerSession) MULTIHOPCALLREQUIREDGAS() (*big.Int, error) {
	return _TokenSpoke.Contract.MULTIHOPCALLREQUIREDGAS(&_TokenSpoke.CallOpts)
}
...
func (_TokenSpoke *TokenSpokeCaller) MULTIHOPSENDREQUIREDGAS(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _TokenSpoke.contract.Call(opts, &out, "MULTI_HOP_SEND_REQUIRED_GAS")
...
//
// Solidity: function MULTI_HOP_SEND_REQUIRED_GAS() view returns(uint256)
func (_TokenSpoke *TokenSpokeSession) MULTIHOPSENDREQUIREDGAS() (*big.Int, error) {
	return _TokenSpoke.Contract.MULTIHOPSENDREQUIREDGAS(&_TokenSpoke.CallOpts)
}

// MULTIHOPSENDREQUIREDGAS is a free data retrieval call binding the contract method 0x5507f3d1.
//
// Solidity: function MULTI_HOP_SEND_REQUIRED_GAS() view returns(uint256)
func (_TokenSpoke *TokenSpokeCallerSession) MULTIHOPSENDREQUIREDGAS() (*big.Int, error) {
	return _TokenSpoke.Contract.MULTIHOPSENDREQUIREDGAS(&_TokenSpoke.CallOpts)
}

...
type TeleporterMessage struct {
	...
	SourceTeleporterAddress common.Address
...
// RetryMessageExecution is a paid mutator transaction binding the contract method 0x275ee579.
//
// Solidity: function retryMessageExecution(bytes32 originChainID, (uint256,address,bytes32,address,address,uint256,address[],(uint256,address)[],bytes) message) returns()
...
// RetrySendCrossChainMessage is a paid mutator transaction binding the contract method 0x6a893760.
//
// Solidity: function retrySendCrossChainMessage(bytes32 destinationChainID, (uint256,address,bytes32,address,address,uint256,address[],(uint256,address)[],bytes) message) returns()
...
// FilterFailedMessageExecution is a free log retrieval operation binding the contract event 0x4e00f99e99bd54c88ad87e0842a20a9236f5a2f7dd50f8b55f7ce299f564bd17.
//
// Solidity: event FailedMessageExecution(bytes32 indexed originChainID, uint256 indexed messageID, (uint256,address,bytes32,address,address,uint256,address[],(uint256,address)[],bytes) message)
...
// WatchFailedMessageExecution is a free log subscription operation binding the contract event 0x4e00f99e99bd54c88ad87e0842a20a9236f5a2f7dd50f8b55f7ce299f564bd17.
//
// Solidity: event FailedMessageExecution(bytes32 indexed originChainID, uint256 indexed messageID, (uint256,address,bytes32,address,address,uint256,address[],(uint256,address)[],bytes) message)
...
// ParseFailedMessageExecution is a log parse operation binding the contract event 0x4e00f99e99bd54c88ad87e0842a20a9236f5a2f7dd50f8b55f7ce299f564bd17.
//
// Solidity: event FailedMessageExecution(bytes32 indexed originChainID, uint256 indexed messageID, (uint256,address,bytes32,address,address,uint256,address[],(uint256,address)[],bytes) message)
...
// FilterReceiveCrossChainMessage is a free log retrieval operation binding the contract event 0xa8837f95d0799ec20633388567fed42f1503e18231cab8f0be2c8e9c97402aac.
//
// Solidity: event ReceiveCrossChainMessage(bytes32 indexed originChainID, uint256 indexed messageID, address indexed deliverer, address rewardRedeemer, (uint256,address,bytes32,address,address,uint256,address[],(uint256,address)[],bytes) message)
...
// WatchReceiveCrossChainMessage is a free log subscription operation binding the contract event 0xa8837f95d0799ec20633388567fed42f1503e18231cab8f0be2c8e9c97402aac.
//
// Solidity: event ReceiveCrossChainMessage(bytes32 indexed originChainID, uint256 indexed messageID, address indexed deliverer, address rewardRedeemer, (uint256,address,bytes32,address,address,uint256,address[],(uint256,address)[],bytes) message)
...
// ParseReceiveCrossChainMessage is a log parse operation binding the contract event 0xa8837f95d0799ec20633388567fed42f1503e18231cab8f0be2c8e9c97402aac.
//
// Solidity: event ReceiveCrossChainMessage(bytes32 indexed originChainID, uint256 indexed messageID, address indexed deliverer, address rewardRedeemer, (uint256,address,bytes32,address,address,uint256,address[],(uint256,address)[],bytes) message)
...
// FilterSendCrossChainMessage is a free log retrieval operation binding the contract event 0xcc22cae9ea512cfa3a2699c6f6e0748d3d6aff6a6cc9a5eb17ef8dae7cab9616.
//
// Solidity: event SendCrossChainMessage(bytes32 indexed destinationChainID, uint256 indexed messageID, (uint256,address,bytes32,address,address,uint256,address[],(uint256,address)[],bytes) message, (address,uint256) feeInfo)
...
// WatchSendCrossChainMessage is a free log subscription operation binding the contract event 0xcc22cae9ea512cfa3a2699c6f6e0748d3d6aff6a6cc9a5eb17ef8dae7cab9616.
//
// Solidity: event SendCrossChainMessage(bytes32 indexed destinationChainID, uint256 indexed messageID, (uint256,address,bytes32,address,address,uint256,address[],(uint256,address)[],bytes) message, (address,uint256) feeInfo)
...
// ParseSendCrossChainMessage is a log parse operation binding the contract event 0xcc22cae9ea512cfa3a2699c6f6e0748d3d6aff6a6cc9a5eb17ef8dae7cab9616.
//
// Solidity: event SendCrossChainMessage(bytes32 indexed destinationChainID, uint256 indexed messageID, (uint256,address,bytes32,address,address,uint256,address[],(uint256,address)[],bytes) message, (address,uint256) feeInfo)

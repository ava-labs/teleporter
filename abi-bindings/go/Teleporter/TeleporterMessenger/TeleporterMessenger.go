...
// FilterMessageExecuted is a free log retrieval operation binding the contract event 0xe8b7ea750f8d9643e3b177029c8a6af35d5fb547475e9c022fa351368525a5d2.
//
// Solidity: event MessageExecuted(bytes32 indexed originChainID, uint256 indexed messageID, bool indexed isRetry)
func (_TeleporterMessenger *TeleporterMessengerFilterer) FilterMessageExecuted(opts *bind.FilterOpts, originChainID [][32]byte, messageID []*big.Int, isRetry []bool) (*TeleporterMessengerMessageExecutedIterator, error) {
	...
	var isRetryRule []interface{}
	for _, isRetryItem := range isRetry {
		isRetryRule = append(isRetryRule, isRetryItem)
	}

	logs, sub, err := _TeleporterMessenger.contract.FilterLogs(opts, "MessageExecuted", originChainIDRule, messageIDRule, isRetryRule)
	if err != nil {
		return nil, err
	}
...
// WatchMessageExecuted is a free log subscription operation binding the contract event 0xe8b7ea750f8d9643e3b177029c8a6af35d5fb547475e9c022fa351368525a5d2.
//
// Solidity: event MessageExecuted(bytes32 indexed originChainID, uint256 indexed messageID, bool indexed isRetry)
func (_TeleporterMessenger *TeleporterMessengerFilterer) WatchMessageExecuted(opts *bind.WatchOpts, sink chan<- *TeleporterMessengerMessageExecuted, originChainID [][32]byte, messageID []*big.Int, isRetry []bool) (event.Subscription, error) {
	...
	logs, sub, err := _TeleporterMessenger.contract.WatchLogs(opts, "MessageExecuted", originChainIDRule, messageIDRule, isRetryRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
...
// ParseMessageExecuted is a log parse operation binding the contract event 0xe8b7ea750f8d9643e3b177029c8a6af35d5fb547475e9c022fa351368525a5d2.
//
// Solidity: event MessageExecuted(bytes32 indexed originChainID, uint256 indexed messageID, bool indexed isRetry)

...
// SendReceipts is a paid mutator transaction binding the contract method 0x46aec315.
//
// Solidity: function sendReceipts(bytes32 originChainID, uint256[] messageIDs, (address,uint256) feeInfo, address[] allowedRelayerAddresses) returns(uint256 messageID)
func (_TeleporterMessenger *TeleporterMessengerTransactor) SendReceipts(opts *bind.TransactOpts, originChainID [32]byte, messageIDs []*big.Int, feeInfo TeleporterFeeInfo, allowedRelayerAddresses []common.Address) (*types.Transaction, error) {
	return _TeleporterMessenger.contract.Transact(opts, "sendReceipts", originChainID, messageIDs, feeInfo, allowedRelayerAddresses)
}

// SendReceipts is a paid mutator transaction binding the contract method 0x46aec315.
//
// Solidity: function sendReceipts(bytes32 originChainID, uint256[] messageIDs, (address,uint256) feeInfo, address[] allowedRelayerAddresses) returns(uint256 messageID)
func (_TeleporterMessenger *TeleporterMessengerSession) SendReceipts(originChainID [32]byte, messageIDs []*big.Int, feeInfo TeleporterFeeInfo, allowedRelayerAddresses []common.Address) (*types.Transaction, error) {
	return _TeleporterMessenger.Contract.SendReceipts(&_TeleporterMessenger.TransactOpts, originChainID, messageIDs, feeInfo, allowedRelayerAddresses)
}

// SendReceipts is a paid mutator transaction binding the contract method 0x46aec315.
//
// Solidity: function sendReceipts(bytes32 originChainID, uint256[] messageIDs, (address,uint256) feeInfo, address[] allowedRelayerAddresses) returns(uint256 messageID)
func (_TeleporterMessenger *TeleporterMessengerTransactorSession) SendReceipts(originChainID [32]byte, messageIDs []*big.Int, feeInfo TeleporterFeeInfo, allowedRelayerAddresses []common.Address) (*types.Transaction, error) {
	return _TeleporterMessenger.Contract.SendReceipts(&_TeleporterMessenger.TransactOpts, originChainID, messageIDs, feeInfo, allowedRelayerAddresses)
}

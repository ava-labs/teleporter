...
func (_TeleporterTokenSource *TeleporterTokenSourceFilterer) FilterTokensAndCallSent(opts *bind.FilterOpts, teleporterMessageID [][32]byte, bridgeAddress []common.Address, sender []common.Address) (*TeleporterTokenSourceTokensAndCallSentIterator, error) {
	...
	logs, sub, err := _TeleporterTokenSource.contract.FilterLogs(opts, "TokensAndCallSent", teleporterMessageIDRule, bridgeAddressRule, senderRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event TokensAndCallSent(bytes32 indexed teleporterMessageID, address indexed bridgeAddress, address indexed sender, (bytes32,address,address,bytes,uint256,uint256,address,address,address,uint256,uint256) input, uint256 amount)
func (_TeleporterTokenSource *TeleporterTokenSourceFilterer) WatchTokensAndCallSent(opts *bind.WatchOpts, sink chan<- *TeleporterTokenSourceTokensAndCallSent, teleporterMessageID [][32]byte, bridgeAddress []common.Address, sender []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _TeleporterTokenSource.contract.WatchLogs(opts, "TokensAndCallSent", teleporterMessageIDRule, bridgeAddressRule, senderRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {

...
func (_TeleporterTokenSource *TeleporterTokenSourceCaller) TokenDecimals(opts *bind.CallOpts) (uint8, error) {
	var out []interface{}
	err := _TeleporterTokenSource.contract.Call(opts, &out, "tokenDecimals")
...
//
// Solidity: function tokenDecimals() view returns(uint8)
func (_TeleporterTokenSource *TeleporterTokenSourceSession) TokenDecimals() (uint8, error) {
	return _TeleporterTokenSource.Contract.TokenDecimals(&_TeleporterTokenSource.CallOpts)
}

// TokenDecimals is a free data retrieval call binding the contract method 0x3b97e856.
//
// Solidity: function tokenDecimals() view returns(uint8)
func (_TeleporterTokenSource *TeleporterTokenSourceCallerSession) TokenDecimals() (uint8, error) {
	return _TeleporterTokenSource.Contract.TokenDecimals(&_TeleporterTokenSource.CallOpts)
}

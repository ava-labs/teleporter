...
//
// Solidity: function transferredBalances(bytes32 remoteBlockchainID, address remoteTokenTransfererAddress) view returns(uint256 balance)
func (_TokenHome *TokenHomeCaller) TransferredBalances(opts *bind.CallOpts, remoteBlockchainID [32]byte, remoteTokenTransfererAddress common.Address) (*big.Int, error) {
	var out []interface{}
	err := _TokenHome.contract.Call(opts, &out, "transferredBalances", remoteBlockchainID, remoteTokenTransfererAddress)
...
//
// Solidity: function transferredBalances(bytes32 remoteBlockchainID, address remoteTokenTransfererAddress) view returns(uint256 balance)
func (_TokenHome *TokenHomeSession) TransferredBalances(remoteBlockchainID [32]byte, remoteTokenTransfererAddress common.Address) (*big.Int, error) {
	return _TokenHome.Contract.TransferredBalances(&_TokenHome.CallOpts, remoteBlockchainID, remoteTokenTransfererAddress)
}

// TransferredBalances is a free data retrieval call binding the contract method 0x3ca563e3.
//
// Solidity: function transferredBalances(bytes32 remoteBlockchainID, address remoteTokenTransfererAddress) view returns(uint256 balance)
func (_TokenHome *TokenHomeCallerSession) TransferredBalances(remoteBlockchainID [32]byte, remoteTokenTransfererAddress common.Address) (*big.Int, error) {
	return _TokenHome.Contract.TransferredBalances(&_TokenHome.CallOpts, remoteBlockchainID, remoteTokenTransfererAddress)
}

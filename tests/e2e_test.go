...
var _ = ginkgo.BeforeSuite(func() {
	...
	teleporterDeployerTransaction, teleporterDeployerAddress, teleporterContractAddress, err := teleporterUtils.ConstructKeylessTransaction(teleporterByteCodeFile, false)
